...
Future<Trending> fetchMovies(String page) async {
  ...
  final response = await http
      .get(Uri.parse("https://api.themoviedb.org/3/discover/movie?api_key=$keyVar&page=$page&language=en-US&sort_by=popularity.desc"), headers: headers);
        ...
        SizedBox(
          ...
          Align(
            ...
            child: Padding(
              ...
              child: Row(
                children: [
                  Text("Movies",style: TextStyle(fontSize: 25,color: Colors.white,fontWeight: FontWeight.bold),),
